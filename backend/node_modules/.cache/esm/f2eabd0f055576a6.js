let fs,express,bodyParser,cors,InputError,AccessError,getEmailFromAuthorization,login,logout,register,getStore,setStore,save;_055‍.x([["default",()=>_055‍.o]]);_055‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_055‍.w("express",[["default",["express"],function(v){express=v}]]);_055‍.w("body-parser",[["default",["bodyParser"],function(v){bodyParser=v}]]);_055‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_055‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);_055‍.w("./service",[["getEmailFromAuthorization",["getEmailFromAuthorization"],function(v){getEmailFromAuthorization=v}],["login",["login"],function(v){login=v}],["logout",["logout"],function(v){logout=v}],["register",["register"],function(v){register=v}],["getStore",["getStore"],function(v){getStore=v}],["setStore",["setStore"],function(v){setStore=v}],["save",["save"],function(v){save=v}]]);
